...
---
## PARAM SHAVAK 2.0  USER MANUAL
This manual is designed to provide comprehensive guidance for the installation, configuration, operation, and maintenance of PARAM Shavak 2.0, the compact table-top supercomputer developed by C-DAC. It serves as a step-by-step reference to help users and administrators make effective use of the system’s hardware and software environment for high performance computing (HPC) applications.

The manual is intended for a diverse group of users, including:

- **System Administrators** – responsible for system setup, configuration, user management, and maintenance.

- **Researchers and Scientists** – who require HPC resources for simulation, modeling, and data-intensive workloads.
- **Students and Educators** – using PARAM Shavak 2.0 as a learning platform to understand parallel computing, HPC application development, and system operations. 
